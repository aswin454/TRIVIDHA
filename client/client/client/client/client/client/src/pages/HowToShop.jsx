        ...
        <div className="container">
          <div className="shop-cta-inner">
            ...
            <div className="cta-row">
              ...
              <a href="https://www.instagram.com/trividhatraditions?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="btn-outline">Explore on Instagram</a>
            </div>
          </div>
        </div>
      </section>
