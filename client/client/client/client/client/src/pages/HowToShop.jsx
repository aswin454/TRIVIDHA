...
const waLink = `https://wa.link/7kuigp?text=${encodeURIComponent('Hi Trividha! I\'d love to start my saree journey with you.')}`;
        ...
        <div className="container">
          <div className="shop-cta-inner">
            ...
            <div className="cta-row">
              ...
              <a href="https://www.instagram.com/trividha.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="btn-outline">Explore on Instagram</a>
            </div>
          </div>
        </div>
      </section>
